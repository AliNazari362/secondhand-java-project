...
/**
 * Embedded response DTO carrying the com.secondhand.service-specific fields of a com.secondhand.service advertisement.
 *
 * <p>Nested inside {@link AdvDetailResponse#serviceDetail()} when the advertisement
 * type is SERVICE. This approach avoids creating a separate com.secondhand.service detail endpoint
 * while keeping the DTO graph free of inheritance and circular references.</p>
 *
 * @param specialCategory free-text sub-category of the com.secondhand.service (e.g., "Plumbing", "Web Design")
...
public record ServiceDetailResponse(
        ...
        /** Free-text sub-category that further classifies the type of com.secondhand.service offered. */
