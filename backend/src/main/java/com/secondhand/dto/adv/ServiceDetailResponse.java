 ...
 *
 * <p>Nested inside {@link AdvDetailResponse} when {@code advType} is SERVICE.
 * This approach avoids creating a separate service detail endpoint while keeping the
 ...
 * @param categoryName    name of the service category
